...
class DigestFormattingTest(unittest.TestCase):
    def test_format_digest_includes_results_standings_and_news_link(self):
        ...
        self.assertIn("FIFA Men's World Cup 2026 daily update", message)
        self.assertIn("England 2-1 Norway", message)
        self.assertIn("1. England 3 pts", message)
